                            ...
                            if (empty($data)) {
                                ...
                                foreach ($data as $b) {
                                    ...
                                    <tr>
                                        ...
                                        <td ><?php echo limit_word($b->isi_ringkas, 50, 0) . "<br><b>File : </b><i><a href='" . base_URL() . "upload/surat_masuk/" . $b->file . "' target='_blank'>" . limit_word($b->file, 50, 1) . "</a>"; ?></td>
                                        <td><?php echo limit_word($b->dari, 50, 0); ?></td>
                                        ...
                                        <td>
                                            ...
                                            if ($b->pengolah == $this->session->user_id) {
                                                ?>
                                                <div>
                                                    <a href="<?php echo site_url('surat/surat_masuk/edit'); ?>/<?php echo $b->id ?>"
                                                       data-toggle="tooltip" class="btn btn-success btn-sm" title="Edit Data"><i class="fa fa-pencil"> </i></a>
                                                    <a href="<?php echo site_url('surat/surat_masuk/del'); ?>/<?php echo $b->id ?>"
                                                    ...
                                                    <a href="<?php echo site_url('surat/surat_disposisi'); ?>/<?php echo $b->id ?>"
                                                       data-toggle="tooltip" class="btn btn-warning btn-sm"  title="Disposisi Surat"><i class="fa fa-check"></i></a>
                                                    <a href="<?php echo site_url('cetak/cetak_disposisi'); ?>/<?php echo $b->id ?>"
